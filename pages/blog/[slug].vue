<template>
  <main class="pt-24 pb-16 px-4 sm:px-8 lg:px-16 bg-primary-950 min-h-screen text-white">
    <article v-if="post">
      <header class="mb-12 text-center">
        ...
        <img v-if="post.coverImage" :src="post.coverImage" :alt="post.title" class="mt-8 w-full max-w-4xl mx-auto rounded-lg shadow-lg object-cover h-64 md:h-96">
      </header>

      <!-- Render Markdown Content -->
      <div class="prose prose-invert lg:prose-xl max-w-4xl mx-auto font-montserrat">
...
.prose :where(pre) {
  background-color: #1f2937; /* Example: gray-800 */
