<template>
  <section
    class="gallery-section px-4 sm:px-8 md:px-16 lg:px-24 py-16 bg-gradient-to-b from-[#21272f] to-[#33241f] overflow-hidden relative">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
      ...
      <div ref="col1" class="column flex flex-col space-y-4">
        <img src="https://picsum.photos/seed/col1img1/400/600" alt="Gallery Image 1"
          class="gallery-image w-full h-auto rounded shadow-lg cursor-pointer">
        <img src="https://picsum.photos/seed/col1img2/400/500" alt="Gallery Image 2"
          class="gallery-image w-full h-auto rounded shadow-lg cursor-pointer">
        <img src="https://picsum.photos/seed/col1img3/400/700" alt="Gallery Image 3"
          class="gallery-image w-full h-auto rounded shadow-lg cursor-pointer">
        <img src="https://picsum.photos/seed/col1img4/400/550" alt="Gallery Image 13"
          class="gallery-image w-full h-auto rounded shadow-lg cursor-pointer">
      </div>

      <div ref="col2" class="column flex flex-col space-y-4">
        <img src="https://picsum.photos/seed/col2img1/400/700" alt="Gallery Image 4"
          class="gallery-image w-full h-auto rounded shadow-lg cursor-pointer">
        <img src="https://picsum.photos/seed/col2img2/400/550" alt="Gallery Image 5"
          class="gallery-image w-full h-auto rounded shadow-lg cursor-pointer">
        <img src="https://picsum.photos/seed/col2img3/400/650" alt="Gallery Image 6"
          class="gallery-image w-full h-auto rounded shadow-lg cursor-pointer">
      </div>

      <div ref="col3" class="column hidden md:flex flex-col space-y-4">
        <img src="https://picsum.photos/seed/col3img1/400/500" alt="Gallery Image 7"
          class="gallery-image w-full h-auto rounded shadow-lg cursor-pointer">
        <img src="https://picsum.photos/seed/col3img2/400/600" alt="Gallery Image 8"
          class="gallery-image w-full h-auto rounded shadow-lg cursor-pointer">
        <img src="https://picsum.photos/seed/col3img3/400/750" alt="Gallery Image 9"
          class="gallery-image w-full h-auto rounded shadow-lg cursor-pointer">
        <img src="https://picsum.photos/seed/col3img4/400/620" alt="Gallery Image 14"
          class="gallery-image w-full h-auto rounded shadow-lg cursor-pointer">
      </div>

      <div ref="col4" class="column hidden lg:flex flex-col space-y-4">
        <img src="https://picsum.photos/seed/col4img1/400/650" alt="Gallery Image 10"
          class="gallery-image w-full h-auto rounded shadow-lg cursor-pointer">
        <img src="https://picsum.photos/seed/col4img2/400/700" alt="Gallery Image 11"
          class="gallery-image w-full h-auto rounded shadow-lg cursor-pointer">
        <img src="https://picsum.photos/seed/col4img3/400/550" alt="Gallery Image 12"
          class="gallery-image w-full h-auto rounded shadow-lg cursor-pointer">
      </div>
    </div>

    <!-- Simple Overlay for Image Zoom -->
    <div v-if="zoomedImageUrl" @click="zoomedImageUrl = null"
